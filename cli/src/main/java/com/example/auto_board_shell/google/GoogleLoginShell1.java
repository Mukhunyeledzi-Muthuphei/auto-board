...
// server.start();
//
// String authUrlWithParams = authUrl + "?client_id=" +
...
// } else {
// throw new UnsupportedOperationException("Desktop browsing is not
// supported.");
// }
// } catch (Exception e) {
// System.err.println(
// "Desktop browsing is not supported. Attempting to open the URL using the
// system's default browser.");
// try {
// Runtime.getRuntime().exec(new String[] { "cmd", "/c", "start",
// authUrlWithParams });
// } catch (IOException ex) {
// System.err.println("Failed to open the URL. Please open it manually: " +
// authUrlWithParams);
// }
// }
//
...
// return query == null ? Map.of() : Map.of(query.split("=")[0],
// query.split("=")[1]);
// }
//
...
// String accessToken = responseBody.split("\"access_token\":
// \"")[1].split("\"", 2)[0];
